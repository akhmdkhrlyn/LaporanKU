...
const initialBoilerData = [
    { id: 1, item: "Cek burner & nozzle" },
    { id: 2, item: "Cek fungsi water level control" },
    { id: 3, item: "Cek fungsi alarm & trip" },
    { id: 4, item: "Cek kebersihan ruang bakar" },
    { id: 5, item: "Cek tekanan kerja safety valve" },
];

const initialUtilityData = [
    { id: 1, item: "Cek tekanan air hydrant" },
    { id: 2, item: "Cek fungsi pompa transfer" },
    { id: 3, item: "Cek panel kontrol chiller" },
    { id: 4, item: "Cek level tangki air utama" },
    { id: 5, item: "Cek fungsi alarm panel listrik" },
];
...
export default CheklistMingguanPage;