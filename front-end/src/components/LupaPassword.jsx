        ...
        <div className="p-6">
            ...
            <form onSubmit={handleSubmitEmail}>
              <div className="mb-8 text-center">
                <div className="flex justify-center mb-4">
                  <MailOutlineIcon sx={{ fontSize: 48 }} className="text-blue-500" />
                </div>
            ...
            <form onSubmit={handleVerifyOtp}>
              ...
              <div className="mb-6">
                <div className="flex justify-between mb-4">
                  {otp.map((digit, index) => (
                    <input
                      ...
                      type="text"
                      maxLength="1"
                      className="w-16 h-16 text-center text-xl font-bold border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                      value={digit}
                ...
                <p className="text-sm text-center text-gray-500">
                  Tidak menerima kode? <button type="button" className="text-blue-500 font-medium">Kirim Ulang</button>
                </p>
              </div>
          ...
          {step === 3 && (
            <form onSubmit={handleResetPassword}>
              <div className="mb-8 text-center">
                <div className="flex justify-center mb-4">
                  <LockIcon sx={{ fontSize: 48 }} className="text-blue-500" />
                </div>
              ...
              <button
                type="submit"
                className={`w-full py-3 rounded-lg font-medium text-white ${
                  loading || (newPassword !== confirmPassword) ? 'bg-blue-400' : 'bg-blue-500 hover:bg-blue-600'
                }`}
          ...
          {step === 4 && (
            <div className="text-center py-8">
              <div className="flex justify-center mb-4">
                <CheckCircleOutlineIcon sx={{ fontSize: 64 }} className="text-blue-500" />
              </div>
