    ...
    <div className="min-h-screen bg-white-100 flex flex-col items-center pt-16 px-4">
      ...
      <div className="bg-white rounded-lg w-full max-w-md p-8">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-blue-500 text-white py-3 rounded-md hover:bg-blue-600 transition duration-300 mb-4"
          >
          ...
          <p className="text-xs text-center text-gray-600 mb-6">
            By continuing, you agree to the <a href="#" className="text-gray-800 hover:text-blue-500 transition duration-300">Terms of use</a> and <a href="#" className="text-gray-800 hover:text-blue-500 transition duration-300">Privacy Policy</a>.
          </p>
        </form>
        
        {/* Register and Forgot Password Links */}
        <div className="flex justify-between text-sm">
          <Link to="/Register" className="text-gray-800 hover:text-blue-500 transition duration-300 group">
            Belum Punya Akun?<br />
            <span className="font-semibold group-hover:underline">Daftar di sini</span>
          </Link>
          <Link to="/forgot-password" className="text-gray-800 hover:text-blue-500 transition duration-300 hover:underline">
            Lupa Password?
          </Link>
        </div>
      </div>
